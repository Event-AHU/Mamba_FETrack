...
# datasets related
from lib.train.dataset import Coesot, Fe108, VisEvent, Lasher, Depthtrack, Felt
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["COESOT", "COESOT_VAL", "FE108", "FE108_VAL", "VisEvent", "VisEvent_VAL", "LASHER", "DEPTHTRACK", "FELT"]
        if name == "COESOT":
