...
dataset_dict = dict(
    ...
    lasher=DatasetInfo(module=pt % "lasher", class_name="LASHERDataset", kwargs=dict(split='test')),
    rgbt234=DatasetInfo(module=pt % "rgbt234", class_name="RGBT234Dataset", kwargs=dict(split='test')),
)
