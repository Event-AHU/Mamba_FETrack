...
class Coesot(BaseVideoDataset):
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        seq_event_path = self._get_event_img_sequence_path(seq_id) # event img
        ...
        return frame_list, anno_frames, object_meta, frame_event_img_list # frame_event_list, frame_event_img_list
